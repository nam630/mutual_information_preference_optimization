...
from .ppo_utils import AdaptiveKLController, Experience, FixedKLController, NaiveExperienceMaker, NaiveReplayBuffer, SelfPlayExperienceMaker


class SelfPlayTrainer(ABC):
    """
    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        self.experience_maker = SelfPlayExperienceMaker(
            actor,
            critic,
            initial_model,
            tokenizer,
    ...
    def fit(
        ...
        for episode in range(start_episode, args.num_episodes):
            ...
            for prompts, _, augmented_prompts, base_prompts, rubrics in self.prompts_dataloader:
                for i, experience in enumerate(
                    self.experience_maker.make_experience_list(prompts, augmented_prompts, base_prompts, rubrics, **self.generate_kwargs)
                ):
