...
from openrlhf.datasets import SelfPlayDataset
from openrlhf.models import Actor, get_llm_for_sequence_regression
from openrlhf.trainer import SelfPlayTrainer
...
def train(args):
    ...
    prompts_dataset = SelfPlayDataset(prompts_data, tokenizer, strategy, input_template=args.input_template)
...
if __name__ == "__main__":
    ...
    # PPO
    parser.add_argument("--use_qwen", action="store_true", default=False)
    parser.add_argument("--use_gemma", action="store_true", default=False)
    parser.add_argument("--add_mutual_info", action="store_true", default=False)
