...
from openrlhf.datasets import CPCDataset
from openrlhf.models import Actor
from openrlhf.trainer import InfoNCETrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sami", action="store_true", default=False)
